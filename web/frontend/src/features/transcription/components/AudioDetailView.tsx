                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <DropdownMenu>
                                                    ...
                                                    <DropdownMenuContent align="end" className="w-56 glass-card rounded-[var(--radius-card)] shadow-[var(--shadow-float)] border-[var(--border-subtle)] p-1.5">
                                                        ...
                                                        <DropdownMenuItem onSelect={() => setAutoScrollEnabled(!autoScrollEnabled)} className="rounded-[8px] cursor-pointer">
                                                            <ArrowDownCircle className={cn("mr-2 h-4 w-4 opacity-70", autoScrollEnabled && "text-[var(--brand-solid)]")} />
                                                            Auto Scroll {autoScrollEnabled ? 'On' : 'Off'}
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onSelect={() => handleSetNotesOpen(!notesOpen)} className="rounded-[8px] cursor-pointer">
                                                        ...
                                                        <DropdownMenuItem onSelect={() => handleSetChatOpen(!chatOpen)} className="rounded-[8px] cursor-pointer">
                                                            <MessageCircle className={cn("mr-2 h-4 w-4 opacity-70", chatOpen && "text-[var(--brand-solid)]")} />
                                                            Chat with Audio
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onSelect={() => setSpeakerRenameOpen(true)} className="rounded-[8px] cursor-pointer">
                                                            <Users className="mr-2 h-4 w-4 opacity-70" />
                                                            Rename Speakers
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onSelect={() => setSummaryDialogOpen(true)} className="rounded-[8px] cursor-pointer text-[var(--brand-solid)] focus:text-[var(--brand-solid)] focus:bg-[var(--brand-light)]">
                                                            <Bot className="mr-2 h-4 w-4" /> AI Summary
                                                        </DropdownMenuItem>
                                                        <DropdownMenuSeparator className="bg-[var(--border-subtle)] my-1" />
                                                        <DropdownMenuItem onSelect={() => transcript && downloadSRT(transcript, audioFile?.title || 'transcript', speakerMappings)} className="rounded-[8px] cursor-pointer">
                                                            <FileImage className="mr-2 h-4 w-4 opacity-70" /> Download SRT
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onSelect={() => { setDownloadFormat('txt'); setDownloadDialogOpen(true); }} className="rounded-[8px] cursor-pointer">
                                                            <AlignLeft className="mr-2 h-4 w-4 opacity-70" /> Download Text
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onSelect={() => { setDownloadFormat('json'); setDownloadDialogOpen(true); }} className="rounded-[8px] cursor-pointer">
                                                            <FileJson className="mr-2 h-4 w-4 opacity-70" /> Download JSON
                                                        </DropdownMenuItem>
                                                        <DropdownMenuSeparator className="bg-[var(--border-subtle)] my-1" />
                                                        <DropdownMenuItem onSelect={() => setExecutionDialogOpen(true)} className="rounded-[8px] cursor-pointer">
                                                            <Activity className="mr-2 h-4 w-4 opacity-70" /> Execution Info
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onSelect={() => setLogsDialogOpen(true)} className="rounded-[8px] cursor-pointer">
